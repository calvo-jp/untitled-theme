...
export const ProgressCircleRange = withContext(styled(ArkProgress.CircleRange), 'circleRange');
export const ProgressCircleTrack = withContext(styled(ArkProgress.CircleTrack), 'circleTrack');
...
export const ProgressValueText = withContext(styled(ArkProgress.ValueText), 'valueText');
