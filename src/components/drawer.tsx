...
export const DrawerBackdrop = withContext(styled(ArkDialog.Backdrop), 'backdrop');
export const DrawerBody = withContext(styled(ark.div), 'body');
export const DrawerCloseTrigger = withContext(styled(ArkDialog.CloseTrigger), 'closeTrigger');
export const DrawerContent = withContext(styled(ArkDialog.Content), 'content');
export const DrawerDescription = withContext(styled(ArkDialog.Description), 'description');
export const DrawerFooter = withContext(styled(ark.div), 'footer');
export const DrawerHeader = withContext(styled(ark.div), 'header');
export const DrawerPositioner = withContext(styled(ArkDialog.Positioner), 'positioner');
